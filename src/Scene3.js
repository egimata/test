  ...
  return (
    <>
      <group name="sceneContainer" ref={group}>
        ...
        <Title name="title" label="EGI MATA" position={[0, 2, -10]} color={PEDRO_COLOR} />
        <Title name="title" label="Go to Website" onClick={event =>  window.location.href='https://myecv.me/egi-mata/'} position={[0, 6, -10]} color={PEDRO_COLOR} />
        <TitleCopies position={[0, 2, -5]} rotation={[0, 0, 0]} layers={[11]} label="PEDRO"  color={PEDRO_COLOR} />
        <Title layers={[11]} name="title" label="SMASH" position={[0, 2, 24]} scale={[-1, 1, 1]} color={CLICKHERE_COLOR} />
